...
def build_draft(
    ...
    return {
        ...
        "editor_notes": [
            ...
            "A late next-line rescue can move a lyric line earlier when a clean previous line is followed by a suspiciously late next-line anchor, but it will not jump across an explicit instrumental placeholder.",
